...
class Scheduler:
    ...
    def show_doctor_schedules(self, doctor_name):
        model = DoctorSchedule(doctor_name)
        schedules = self.doctor_schedules
        check_schedule = schedules.get(doctor_name)
        available_slots = model.get_available_slots(check_schedule)
